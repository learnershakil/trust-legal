...
const ChatBot: React.FC<ChatBotProps> = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content:
        "Hi! I'm the Trust Legal AI assistant. How can I help you today?",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <div className="fixed bottom-20 right-6 w-80 md:w-96 h-96 bg-gradient-to-b from-[#202d4a] to-[#111827] rounded-lg shadow-2xl flex flex-col overflow-hidden border border-[#ba9669]/30 z-50 transition-all duration-300 ease-in-out">
      ...
      <form
        ...
        className="p-4 border-t border-[#ba9669]/20 bg-[#111827]/80 backdrop-blur-sm"
      >
