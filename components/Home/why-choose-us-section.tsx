...
export default function WhyChooseUsSection() {
  ...
  return (
    <section
      id="why-choose-us"
      className="py-20 md:py-28 bg-gradient-to-b from-white to-[#f9f9f9] relative"
    >
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#202d4a] sm:text-4xl md:text-5xl">
            A Tradition of{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {features.map((feature, index) => (
            ...
            >
              <div
                className="inline-flex items-center justify-center p-3 bg-[#ba9669]/10 rounded-xl mb-5 
              ...
              <p className="text-[#202d4a]/70 leading-relaxed">
                {feature.description}
              </p>
            </div>
          ))}
