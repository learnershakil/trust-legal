...
export default function Header() {
  ...
  return (
    <>
      {/* Top contact bar */}
      <div className="hidden md:block bg-[#202d4a] text-white py-2">
      ...
      <div className="container mx-auto flex items-center justify-between px-4 md:px-6">
        ...
        <div className="relative flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-br from-[#202d4a] to-[#2a3b52] overflow-hidden shadow-sm transition-transform group-hover:scale-105">
        ...
        <div className="transition-transform group-hover:translate-x-1">
          ...
          <span className="text-[#202d4a]">TRUST</span>
        ...
        <Link
          ...
          bg-gradient-to-r from-[#202d4a] to-[#2a3b52] text-white hover:shadow-md hover:translate-y-[-1px] 
      ...
      {isOpen && (
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          <div className="flex h-14 w-14 items-center justify-center rounded-md bg-gradient-to-br from-[#202d4a] to-[#2a3b52]">
        ...
        <nav className="flex flex-col space-y-5">
          ...
          <div className="text-center font-medium text-[#202d4a] mb-2">Practice Areas</div>
        ...
        <div className="mt-8 space-y-6">
          ...
          href="/contact-us"
          onClick={() => setIsOpen(false)}
          className="block w-full py-3 text-center font-medium rounded-md bg-gradient-to-r from-[#202d4a] to-[#2a3b52] text-white"
          >
          Free Consultation
          </Link>
