...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="bg-gradient-to-b from-white to-[#f8f5f0] py-24 md:py-32"
    >
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            {/* <div className="absolute -left-6 -top-6 h-24 w-24 rounded-full bg-[#202d4a]/20 backdrop-blur-md"></div>
            <div className="absolute top-1/2 right-12 h-16 w-16 rounded-full bg-[#202d4a]/10 backdrop-blur-sm"></div> */}
          </div>
          <div
          ...
          >
            <div className="space-y-4">
              <div className="inline-block rounded-md border border-[#ba9669]/40 bg-[#ba9669]/10 px-5 py-2 text-sm font-semibold tracking-wide text-[#9a7954]">
                Our Expertise
              </div>
              <h2 className="text-3xl font-bold tracking-tight text-[#1a2537] sm:text-4xl md:text-5xl lg:leading-tight">
                Legal Excellence with{" "}
                <span className="text-[#ba9669] border-b-2 border-[#ba9669]/20 pb-1">
                  Integrity & Precision
                </span>
              </h2>
            ...
            <div className="pt-2">
              <Link href="/practice-areas">
                <button className="inline-flex items-center gap-2 rounded-lg bg-[#202d4a] px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-[#ba9669] focus:outline-none focus:ring-2 focus:ring-[#ba9669]/50">
