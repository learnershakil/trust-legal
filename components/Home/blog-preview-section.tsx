    ...
    <section id="blog-preview" className="py-16 md:py-24 bg-white">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
          <div>
            <div className="inline-block rounded-lg bg-[#ba9669]/20 px-3 py-1 text-sm font-medium text-[#ba9669]">
              Latest Insights
            </div>
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#202d4a] sm:text-4xl">
          ...
          {articles.map((article, index) => (
            ...
            >
              <div className="aspect-w-16 aspect-h-9 relative overflow-hidden">
                <div className="w-full h-48 bg-gradient-to-r from-[#202d4a]/5 to-[#ba9669]/10 relative">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-[#202d4a] text-white px-3 py-1 rounded-full text-xs font-medium">
                    {article.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-[#202d4a] mb-3 group-hover:text-[#ba9669] transition-colors leading-tight">
                  {article.title}
                </h3>
                <p className="text-[#202d4a]/70 mb-5 text-sm">
                  {article.excerpt}
                </p>
                <Link
