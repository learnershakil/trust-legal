          ...
          >
            ...
            <div className="flex flex-col gap-4 min-[400px]:flex-row">
              ...
              <Link href="/practice-areas">
                <button className="inline-flex h-12 items-center justify-center rounded-md border border-[#9e814d]/30 bg-transparent px-8 text-sm font-medium text-[#192841] shadow-sm transition-all duration-300 hover:bg-[#9e814d]/5 hover:border-[#9e814d]/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#9e814d] group">
                  Our Practice Areas{" "}
