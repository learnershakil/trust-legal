          ...
          <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                ...
                resolution and protecting your legal and business interests.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-[#202d4a]/70 max-w-3xl mx-auto">
                From pre-litigation strategy to courtroom advocacy and
                enforcement of judgments, our litigation practice offers
              ...
              {[
                {
                  ...
                  description:
                    "We thoroughly evaluate the merits of your case, identify strengths and weaknesses, and determine the optimal strategy for resolution.",
                },
                {
                  icon: <BarChart className="h-6 w-6" />,
                  title: "Case Development",
                  description:
                    "We gather evidence, interview witnesses, research relevant law, and prepare all necessary documentation to build a compelling case.",
                },
                {
                  icon: <ArrowDownUp className="h-6 w-6" />,
                  title: "Resolution Strategy",
                  description:
                    "We pursue the most appropriate path to resolution, whether through negotiation, mediation, arbitration, or court proceedings.",
                },
                {
                  icon: <Gavel className="h-6 w-6" />,
                  title: "Trial & Enforcement",
                  description:
                    "When necessary, we provide skilled advocacy in court and ensure that judgments in your favor are properly enforced.",
                },
              ].map((step, index) => (
              ...
              {[
                {
                  ...
                  description:
                    "Benefit from our litigation experience, legal insights, and strategic approach to position your case for the best possible outcome.",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Receive comprehensive evaluations of potential outcomes and risks, allowing you to make informed decisions throughout the litigation process.",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Strong case preparation and litigation readiness often create leverage for more favorable settlement terms.",
                },
                {
                  title: "Peace of Mind",
                  description:
                    "Rest assured knowing that experienced advocates are protecting your interests and navigating complex legal procedures on your behalf.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#202d4a] mb-6">
                  Resolving a Complex Commercial Dispute
                </h2>
                <p className="text-[#202d4a]/70 mb-4">
                  A mid-sized manufacturing company faced a significant breach
                  of contract claim from a major supplier that threatened their
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    ...
                    <p className="text-[#202d4a]/70">
                      The supplier was demanding substantial damages for alleged
                      breach of a long-term supply agreement. Our client
                      maintained that poor quality and late deliveries justified
                      their actions. With over $1.5 million at stake and
                      potential damage to industry relationships, a strategic
                  ...
                  <div>
                    ...
                    <p className="text-[#202d4a]/70">
                      We conducted a comprehensive review of all contract
                      documents and performance records, identified key leverage
                      points, and developed a strong counterclaim. Rather than
                      proceeding directly to litigation, we proposed a
                      structured mediation with clearly defined parameters,
                      giving both sides a face-saving path to resolution.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium text-[#202d4a] mb-2">
                    ...
                    <p className="text-[#202d4a]/70">
                      Through strategic negotiation and mediation, we secured a
                      settlement at less than 30% of the original demand, with
                      favorable payment terms and a restructured supply
                      arrangement. The matter was resolved in four months,
                      saving significant litigation costs and preserving
