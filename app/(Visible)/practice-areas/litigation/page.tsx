    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative bg-[#202d4a] text-white">
        ...
        <div className="max-w-3xl">
          ...
          resolution and protecting your legal and business interests in Ontario.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <p className="text-[#202d4a]/70 mb-6">
            ...
            alternative dispute resolution, or advocacy before Ontario courts.
          </p>
          <p className="text-[#202d4a]/70 mb-6">
      ...
      <section id="services" className="py-16 md:py-24 bg-[#f9f9f9]">
        ...
        <div className="text-center mb-16">
          ...
          From pre-litigation strategy to advocacy before Ontario courts and
      ...
      <section className="py-16 md:py-24 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <p className="text-[#202d4a]/70 mb-4">
            An Ontario-based mid-sized manufacturing company faced a significant breach
          ...
          <div className="space-y-6 mb-6">
            ...
            <p className="text-[#202d4a]/70">
              ...
              their actions. With over $1.5 million CAD at stake and
            ...
            <p className="text-[#202d4a]/70">
              ...
              structured mediation through Ontario&apos;s Mandatory Mediation Program, with clearly defined parameters,
            ...
            <p className="text-[#202d4a]/70">
              ...
              important industry relationships within the Ontario business community.
            </p>
            </div>
          </div>
          </div>
