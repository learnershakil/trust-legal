    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="py-16 md:py-24 bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#202d4a] mb-6">
            Helping an Ontario Tech Startup Navigate Growth
          </h2>
          <p className="text-[#202d4a]/70 mb-4">
            An Ontario technology startup approached us during their critical
          ...
          <div className="space-y-6 mb-6">
            ...
            <p className="text-[#202d4a]/70">
              ...
              employment agreements for new hires under Ontario employment laws, and prepare
            ...
            <p className="text-[#202d4a]/70">
              ...
              strategy covering corporate restructuring under the Ontario Business Corporations Act, IP protection,
            ...
            <p className="text-[#202d4a]/70">
              ...
              them for sustainable growth in Ontario&apos;s competitive tech sector.
            </p>
            </div>
          </div>
          </div>
          ...
          <Image
            src="/business-case-study.jpg"
            alt="Ontario Business Case Study"
            fill
            className="object-cover"
          />
          </div>
