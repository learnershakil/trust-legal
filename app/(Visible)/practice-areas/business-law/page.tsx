...
export default function BusinessLawPage() {
  const businessServices = [
    {
      ...
      description:
        "Strategic guidance on selecting the optimal business structure, preparing and filing required documentation, and ensuring regulatory compliance during the incorporation process.",
    ...
    },
    {
      ...
      description:
        "Comprehensive contract services including drafting, negotiation, review, and revision of all types of business agreements to protect your interests and minimize risk.",
    ...
    },
    {
      ...
      description:
        "Guidance on establishing effective governance structures, board practices, and corporate policies to ensure compliance and promote sound decision-making.",
    ...
    },
    {
      ...
      description:
        "Expert assistance through all phases of the M&A process, from initial strategy and due diligence to negotiation, documentation, and post-closing integration.",
      icon: <Building className="h-6 w-6" />,
      details: [
    ...
    },
    {
      ...
      description:
        "Comprehensive employment law services covering hiring practices, employee handbooks, workplace policies, and representation in employment disputes.",
      icon: <Users className="h-6 w-6" />,
      details: [
    ...
    },
    {
      ...
      description:
        "Navigating complex regulatory landscapes to ensure your business operations remain compliant with federal, provincial, and local regulations.",
  ...
  const businessFAQs = [
    ...
    {
      question:
        "What's the difference between a corporation and other business structures?",
      answer:
          ...
          <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Comprehensive legal solutions for businesses of all sizes, from
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#202d4a] mb-6">
                  Business Legal Solutions That Drive Success
                </h2>
                ...
                <p className="text-[#202d4a]/70 mb-6">
                  ...
                  decisions and protect your business interests.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-[#202d4a]/70 max-w-3xl mx-auto">
                ...
                address your company&apos;s legal needs.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "Understand",
                  description:
                    "We begin by thoroughly understanding your business model, objectives, challenges, and industry context.",
                },
                {
                  icon: <FileText className="h-6 w-6" />,
                  title: "Analyze",
                  description:
                    "Our team analyzes your specific situation to identify legal needs and potential risks requiring attention.",
                },
                {
                  icon: <Users className="h-6 w-6" />,
                  title: "Strategize",
                  description:
                    "We develop customized legal strategies aligned with your business goals and risk tolerance.",
                },
                {
                  icon: <Shield className="h-6 w-6" />,
                  title: "Implement & Monitor",
                  description:
                    "We execute the agreed strategy and provide ongoing support as your business evolves.",
                },
              ].map((step, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose Our Business Law Services
              </h2>
              <p className="text-gray-300 max-w-3xl mx-auto">
                Our business-focused legal approach delivers tangible benefits
              ...
              {[
                {
                  ...
                  description:
                    "Proactively identify and address legal risks before they become costly problems through comprehensive compliance reviews and strategic planning.",
                },
                {
                  title: "Business Continuity",
                  description:
                    "Ensure your business operations continue smoothly with legally sound governance structures, succession planning, and crisis management protocols.",
                },
                {
                  title: "Strategic Growth",
                  description:
                    "Position your business for expansion with legal frameworks that support scaling, new market entry, and strategic partnerships or acquisitions.",
                },
                {
                  title: "Cost Efficiency",
                  description:
                    "Prevent expensive legal issues through proper documentation, compliance, and risk management, saving significant costs in the long run.",
                },
                {
                  title: "Competitive Advantage",
                  description:
                    "Leverage legal structures and protections that allow your business to operate more efficiently and capitalize on opportunities faster than competitors.",
                },
                {
                  title: "Peace of Mind",
                  description:
                    "Focus on running your business knowing that your legal matters are being handled by experienced professionals committed to your success.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-[#202d4a] mb-6">
                  Helping a Tech Startup Navigate Growth
                </h2>
                <p className="text-[#202d4a]/70 mb-4">
                  A technology startup approached us during their critical
                  growth phase. They needed comprehensive legal support as they
                  prepared for a significant funding round and expanded their
                  team.
                </p>
                <div className="space-y-6 mb-6">
                  <div>
                    ...
                    <p className="text-[#202d4a]/70">
                      The company needed to restructure their corporate
                      governance, develop IP protection strategies, create
                      employment agreements for new hires, and prepare
                      documentation for investors—all while maintaining focus on
                  ...
                  <div>
                    ...
                    <p className="text-[#202d4a]/70">
                      We provided a dedicated legal team that worked closely
                      with the founders to understand their business model and
                      growth objectives. We developed a comprehensive legal
                      strategy covering corporate restructuring, IP protection,
                      employment policies, and investment documentation.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium text-[#202d4a] mb-2">
                    ...
                    <p className="text-[#202d4a]/70">
                      With our support, the company successfully closed their
                      funding round, implemented solid governance structures,
                      protected their intellectual property, and scaled their
                      team—all with legally sound frameworks that positioned
