  ...
  const immigrationServices = [
    {
      ...
      description:
        "Expert guidance through all pathways to permanent residency in Canada, including Express Entry, Provincial Nominee Programs, and family-based applications.",
    ...
    },
    {
      ...
      description:
        "Assistance with temporary residence applications, including work permits, study permits, and visitor visas for various purposes and situations.",
    ...
    },
    {
      ...
      description:
        "Strategic immigration solutions for entrepreneurs, investors, and skilled professionals looking to bring their talents to Canada.",
    ...
    },
    {
      ...
      description:
        "Reuniting families through spousal sponsorship, parent and grandparent sponsorship, and other family class immigration programs.",
    ...
    },
    {
      ...
      description:
        "Support throughout the Canadian citizenship application process, from eligibility assessment to test preparation and citizenship ceremonies.",
      icon: <FileText className="h-6 w-6" />,
      details: [
    ...
    },
    {
      ...
      description:
        "Representation for various immigration appeals and inadmissibility issues, including deportation defense and humanitarian applications.",
  ...
  const immigrationFAQs = [
    {
      ...
      answer:
        "Canada offers several pathways to permanent residency, including Express Entry (for skilled workers), Provincial Nominee Programs (province-specific streams), Family Sponsorship (for relatives of Canadian citizens/PRs), Business Immigration (for entrepreneurs and investors), and humanitarian programs like refugee protection. Each pathway has specific eligibility requirements and application procedures. During your consultation, we can assess your situation and recommend the most suitable option.",
    },
    {
      question: "How long does the immigration process typically take?",
      answer:
        "Processing times vary significantly depending on the immigration program, your country of residence, application completeness, and current IRCC workloads. Express Entry applications can be processed in 6-12 months, while family sponsorship may take 12-24 months. Provincial programs and business immigration can range from 12-36 months. During your consultation, we can provide current processing time estimates for your specific situation based on the latest IRCC data.",
    },
    {
          ...
          <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                Navigating your path to Canada with expert guidance and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#202d4a]/70 mb-6">
                  ...
                  Canadian immigration regulations with a compassionate approach
                  to help you navigate the complexities of moving to Canada.
                </p>
                <p className="text-[#202d4a]/70 mb-6">
                  Under the leadership of Omung Gupta, our immigration team
                  stays current with rapidly changing immigration policies to
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-[#202d4a]/70 max-w-3xl mx-auto">
                ...
                address your Canadian immigration needs, whether you&apos;re
                looking to visit, study, work, or permanently settle in Canada.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-[#202d4a]/70 max-w-3xl mx-auto">
                ...
                preparation throughout your immigration process.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "Assessment",
                  description:
                    "We begin with a comprehensive assessment of your background, goals, and eligibility for various immigration pathways.",
                },
                {
                  icon: <FileText className="h-6 w-6" />,
                  title: "Strategy Development",
                  description:
                    "Based on your assessment, we develop a customized immigration strategy that maximizes your chances of success.",
                },
                {
                  icon: <Users className="h-6 w-6" />,
                  title: "Application Preparation",
                  description:
                    "We prepare and review all documentation, ensuring accuracy, completeness, and compliance with current requirements.",
                },
                {
                  icon: <Shield className="h-6 w-6" />,
                  title: "Submission & Follow-up",
                  description:
                    "We submit your application and handle all communication with immigration authorities until a decision is reached.",
                },
              ].map((step, index) => (
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-300 max-w-3xl mx-auto">
                ...
                advantages that help smooth your path to Canada.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Benefit from our deep understanding of Canadian immigration law, policies, and procedures across all pathways to Canada.",
                },
                {
                  title: "Personalized Strategy",
                  description:
                    "Receive a tailored immigration plan that considers your unique background, qualifications, and goals for coming to Canada.",
                },
                {
                  title: "Reduced Complexity",
                  description:
                    "Navigate the complex immigration system with ease as we handle paperwork, requirements, and communications with authorities.",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Save valuable time with our streamlined processes that minimize delays and keep your application moving forward.",
                },
                {
                  title: "Peace of Mind",
                  description:
                    "Proceed with confidence knowing that your immigration matter is being handled by experienced professionals committed to your success.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-[#202d4a]/70 mb-4">
                  ...
                  attempts to sponsor their spouse to Canada, causing years of
                ...
                <div className="space-y-6 mb-6">
                  <div>
                    ...
                    <p className="text-[#202d4a]/70">
                      ...
                      the Canadian sponsor was experiencing health issues
                  ...
                  <div>
                    ...
                    <p className="text-[#202d4a]/70">
                      ...
                      Canada, ending their long separation and allowing them to
        ...
        <section className="py-16 md:py-24 bg-[#202d4a] text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              Canadian immigration system and develop a strategy tailored to
