          ...
          <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-300 mb-6">
                We&apos;re here to provide the legal expertise you need. Reach
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[#202d4a]/70 mb-6">
                  Whether you have a specific legal inquiry or would like to
                  schedule a consultation, we&apos;re here to help. Fill out the
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-[#202d4a]/70">
                  ...
                  including contracts, correspondence, court papers, and
                  identification. This helps us provide the most accurate
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-[#202d4a]/70">
                  Initial consultations typically last 30-60 minutes, depending
                  on the complexity of your legal matter. This gives us enough
                  time to understand your situation and discuss potential
                  approaches.
                </p>
              </div>
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-[#202d4a]/70">
                  Yes, we offer consultations via phone or video conference for
                  clients who prefer remote meetings. Please indicate your
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <p className="text-[#202d4a]/70">
                  ...
                  debit cards, e-transfers, and checks. Payment plans may be
                  available depending on your specific circumstances and legal
                  needs.
                </p>
              </div>
            </div>
