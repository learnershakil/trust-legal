...
export default function BlogPage() {
  ...
  // Sample blog articles with valid Unsplash images
  const articles: Article[] = [
    {
      id: 1,
      title: "Key Considerations for Business Incorporation in Ontario",
      excerpt:
        "Learn about the essential legal considerations when incorporating your business in Ontario, including liability protection, tax implications, and ongoing corporate obligations.",
      date: "March 1, 2025",
    ...
    },
    {
      ...
      excerpt:
        "Stay informed about the latest updates to immigration policies that may affect your status, including new pathways to permanent residency and changes to processing times.",
      date: "February 20, 2025",
      category: "Immigration",
      image:
        "https://images.unsplash.com/photo-1569225034143-754335938607?auto=format&fit=crop&q=80",
      featured: true,
    },
    {
      id: 3,
      ...
      excerpt:
        "A comprehensive guide to navigating complex commercial real estate deals in today's market, including due diligence, financing options, and closing procedures.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how small businesses can navigate litigation efficiently while minimizing costs and business disruption through strategic legal approaches.",
    ...
    },
    {
      ...
      excerpt:
        "Essential guidelines for employers when drafting and negotiating employment contracts to ensure compliance with Ontario labor laws and protect business interests.",
    ...
    },
    {
      ...
      excerpt:
        "A detailed overview of the family sponsorship immigration process in Canada, including eligibility requirements, documentation, and processing timelines.",
      date: "January 3, 2025",
      category: "Immigration",
      image:
        "https://images.unsplash.com/photo-1581188477248-f3c77ccc49fa?auto=format&fit=crop&q=80",
      featured: false,
    },
    {
      id: 7,
      ...
      excerpt:
        "Practical advice for homeowners facing boundary disputes, including legal remedies, survey considerations, and alternative resolution approaches.",
    ...
    },
    {
      ...
      excerpt:
        "Expert tips on how to prepare for and conduct yourself during depositions to strengthen your litigation position and avoid common pitfalls.",
          ...
          <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-300">
                Stay informed with the latest legal developments, expert
                analysis, and practical guidance from the Trust Legal team.
              </p>
            </div>
          </div>
        </section>
          ...
          <section className="py-16 md:py-20 bg-white">
            <div className="container mx-auto px-4">
              <div className="flex justify-between items-center mb-10">
                <h2 className="text-2xl md:text-3xl font-bold text-[#202d4a]">
                  Featured Articles
                </h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {featuredArticles.map((article) => (
                  <div
                    key={article.id}
                    className="group bg-[#f9f9f9] rounded-lg overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow"
                  >
                    ...
                    <div className="p-6">
                      ...
                      <Link
                        ...
                        className="text-[#ba9669] font-medium inline-flex items-center hover:underline"
                      >
            ...
            <div className="mb-12">
              ...
              {filteredArticles.length > 0 ? (
                  ...
                  {filteredArticles.map((article) => (
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-[#202d4a]/70 mb-3 text-sm line-clamp-3">
                          {article.excerpt}
                        </p>
                        <Link
                          href={`/blog/${article.id}`}
                          className="text-[#ba9669] text-sm font-medium inline-flex items-center hover:underline"
                        >
                          Read More <ChevronRight className="ml-1 h-4 w-4" />
                        </Link>
                      </div>
                ...
                <div className="text-center py-10 bg-white rounded-lg border border-gray-200">
                  <p className="text-lg text-[#202d4a]/70">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                Receive the latest legal insights, news, and updates directly to
                your inbox. We respect your privacy and will never share your
                information.
              </p>
