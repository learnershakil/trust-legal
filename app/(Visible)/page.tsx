  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main>
        ...
        <section id="contact" className="bg-[#202d4a] py-16 md:py-24 text-white">
          ...
          <p className="max-w-[600px] text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            TRUST LEGAL provides reliable legal solutions in Corporate Law, Civil Litigation, Immigration, and Real Estate.
          ...
          <p className="text-sm text-gray-300">206-6760 Davand Drive, Mississauga, Ontario, L5T 2L9</p>
            ...
            <div className="mt-6 pt-2 border-t border-[#ba9669]/30">
              ...
              <p className="text-sm text-gray-300">BARRISTER, SOLICITOR</p>
            </div>
          </div>
              </div>
              <div className="rounded-lg border border-[#ba9669]/30 bg-[#202d4a]/80 p-6 shadow-lg">
          <ContactForm />
              </div>
            </div>
          </div>
