            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-6" data-aos="fade-right">
                ...
                <p className="text-[#202d4a]/80 mb-8 text-lg">
                  ...
                  legal matters across Business Law, Litigation, Immigration,
                  and Real Estate, ensuring comprehensive representation for all
                  your legal needs.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3">
                ...
                <div className="p-8 md:p-10 md:col-span-2">
                  ...
                  <p className="text-[#202d4a]/80 mb-4 text-lg">
                    ...
                    Liens, Landlord & Tenant disputes, and various other
                    practice areas.
                  </p>
        ...
        <section className="py-20 md:py-28 bg-gradient-to-br from-[#202d4a] to-[#152030] text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              learn how we can assist with your legal matters.
            </p>
