...
export default function AboutPage() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative h-[700px] bg-[#202d4a] text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#202d4a]/95 via-[#202d4a]/85 to-[#202d4a]/75 z-0"></div>
        ...
        >
          ...
          >
          Trust Legal:{" "}
          <span className="text-[#ba9669] relative">
            Your Trusted
          ...
          integrity, strategic insight, and a commitment to achieving
          optimal outcomes for our distinguished clientele.
          </p>
          ...
          <Link
            href="/practice-areas"
            className="group inline-flex items-center justify-center px-8 py-4 border border-[#ba9669] text-[#ba9669] font-medium rounded-md transition-all duration-300 backdrop-blur-sm hover:bg-[#ba9669]/10 hover:shadow-lg hover:shadow-[#ba9669]/10 hover:-translate-y-[3px]"
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              className="h-5 w-5 mr-2 opacity-80 group-hover:opacity-100 transition-opacity" 
              viewBox="0 0 20 20" 
              fill="currentColor"
            >
          ...
          <div
          className="mt-14 flex items-center space-x-6"
          data-aos="fade-up"
          data-aos-delay="500"
          >
      ...
      {/* Lawyer Profile with Modern Design */}
      <section className="py-20 md:py-28 bg-[#f8f9fb]">
        ...
        >
          ...
          <div className="relative h-[350px] md:h-auto">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#202d4a]/80 to-transparent md:hidden"></div>
          </div>
          <div className="p-8 md:p-10 md:col-span-2">
            <h3 className="text-2xl font-bold text-[#202d4a] mb-1">
            OMUNG GUPTA
            </h3>
            ...
            <span className="ml-2 text-[#202d4a]/70">
              Principal Lawyer
            </span>
            </p>
            <div className="w-16 h-1 bg-[#ba9669]/50 mb-6"></div>
            <p className="text-[#202d4a]/80 mb-4 text-lg">
            With comprehensive experience across multiple legal
            disciplines in both Canada and India, Omung Gupta provides
            strategic solutions tailored to each client&apos;s unique
            needs. As Principal Lawyer at Trust Legal, he delivers
            excellence in Corporate/Commercial Litigation, Construction 
            Lien Act matters, Landlord & Tenant Board proceedings, and various other
            practice areas.
            </p>
            <div className="space-y-4 bg-[#f8f9fb] p-6 rounded-lg border-l-4 border-[#ba9669]">
            <div className="flex items-start">
              <span className="w-32 text-[#202d4a] font-medium shrink-0">
              Education:
              </span>
            ...
            <div className="flex items-center">
              <span className="w-32 text-[#202d4a] font-medium">
              Languages:
              </span>
              <span className="text-[#202d4a]/80">English, Hindi</span>
            </div>
            </div>
          </div>
          </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-[#202d4a]/70 text-lg">
          At Trust Legal, our work is guided by a set of core values that
          inform every aspect of our practice and client interactions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
          {
            ...
            title: "Integrity",
            description:
            "We uphold the highest ethical standards and maintain transparency in all client interactions.",
          },
          {
            icon: "award",
            title: "Excellence",
            description:
            "We are committed to delivering exceptional legal services and achieving optimal outcomes for our clients.",
          },
          {
            icon: "users",
            title: "Accessibility",
            description:
            "We ensure our clients have direct access to legal counsel and maintain open lines of communication.",
          },
          {
            icon: "lightbulb",
            title: "Innovation",
            description:
            "We embrace innovative approaches to legal challenges while respecting established legal principles.",
          },
          ].map((value, index) => (
          <div
            key={index}
          ...
          >
            ...
            <p className="text-[#202d4a]/70">{value.description}</p>
          </div>
          ))}
        </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-[#202d4a] to-[#152030] text-white relative overflow-hidden">
        ...
        <div
          className="w-24 h-1 bg-[#ba9669] mx-auto mb-8"
          data-aos="fade-up"
          data-aos-delay="100"
        ></div>
        <p
          ...
          data-aos-delay="200"
        >
          Trust Legal is committed to providing exceptional legal
          representation. Contact us today to schedule a consultation and
          learn how we can assist with your legal matters in Ontario.
        </p>
        <div data-aos="fade-up" data-aos-delay="300">
          <Link
          href="/contact-us"
          className="inline-flex items-center justify-center px-8 py-4 bg-[#ba9669] text-white font-medium rounded-md hover:bg-[#ba9669]/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 duration-300"
          >
          Schedule a Consultation
          <svg
            xmlns="http://www.w3.org/2000/svg"
