...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-[#202d4a] text-white p-8 flex-col justify-between">
        <div>
          <div className="mb-8">
            <Image
              src="/logo.png"
            ...
            <p className="text-gray-300 max-w-md">
              Access your secure portal for comprehensive legal services and
              case management.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-[#ba9669]/30 pt-6">
          ...
          <p className="text-sm text-gray-300">
            Reliable legal solutions in Business Law, Litigation, Immigration,
            and Real Estate.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
        <div className="w-full max-w-md">
          <div className="md:hidden mb-10 text-center">
            ...
            />
            <h1 className="text-2xl font-bold text-[#202d4a]">Welcome Back</h1>
          </div>

          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
            <h2 className="text-2xl font-semibold text-[#202d4a] mb-6 hidden md:block">
              Sign In
            </h2>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  href="/contact-us"
                  className="ml-1 text-[#ba9669] hover:underline font-medium"
                >
                  Contact us
                </Link>
              </p>
